...
public class Sighting {
  ...
  public Sighting(int animal_id, String lat_long, String ranger_name) {
  ...
  public void save() {
    try(Connection con = DB.sql2o.open()) {
      String sql = "INSERT INTO sightings (animal_id, lat_long, ranger_name, time_sighted) VALUES (:animal_id, :lat_long, :ranger_name, now());";
